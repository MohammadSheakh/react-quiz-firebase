...
export default function useAnswers(videoID) {
    ...
    const [answers, setAnswers] = useState([]); // jei answer gula database theke anbo .. shegula ekhane thakbe ..
    ...
    useEffect(() => {
        ...
        async function fetchAnswers() {
            ...
            // create korte hobe ...
            const answerRef = ref(db, "answers/" + videoID + "/questions"); // she amake ref nam e ekta function dey..
            ...
            try {
                ...
                const snapshot = await get(answerQuery); // get er moddhe query ta diye dite hoy ..
